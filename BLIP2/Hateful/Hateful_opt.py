...
def main(args, config):
    ...
    tokenizer = AutoTokenizer.from_pretrained("/mnt/raid/yangcp/checkpoint/BLIP2/opt")
    #### Model #### 
...
if __name__ == '__main__':
    ...
    parser.add_argument('--text_encoder', default='/mnt/raid/yangcp/checkpoint/BLIP2/opt')
