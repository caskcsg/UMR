...
class ALBEF(nn.Module):
    def __init__(self,                 
        ...
        self.feature_map = nn.Linear(1280, 768)

        self.img_BayesCap = BayesCap_MLP(inp_dim=768, out_dim=768, hid_dim=256, num_layers=3, p_drop=0.1)
        self.txt_BayesCap = BayesCap_MLP(inp_dim=768, out_dim=768, hid_dim=256, num_layers=3, p_drop=0.1)
        
        self.mlp_encoder = MLPEncoder(activate='gelu', d_in=[100, 2, 768], d_hiddens=[[50, 1, 256], [10,1,128]], d_outs=[[50, 1, 256], [10,1,128]], dropouts=[0.5,0.5,0.5], bias=False, ln_first=False, res_project=[True,True])
